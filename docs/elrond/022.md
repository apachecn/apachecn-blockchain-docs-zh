...
> 原文:[https://docs.elrond.com/tokens/nft-tokens](https://docs.elrond.com/tokens/nft-tokens)
...
然而，有时在发布 NFT 之前上传元数据文件是不可能的(例如，当从智能合约发布时)，在这些情况下，可以在发布之后通过发送附加事务用元数据文件更新 NFT。你可以在这里找到更多关于如何更新属性的信息
...
该角色可以是文档中指定的角色之一(例如:ESDTRoleNFTCreate)  ```
{
  "data": {
    "tokens": [
      "ABC-36tg72"
